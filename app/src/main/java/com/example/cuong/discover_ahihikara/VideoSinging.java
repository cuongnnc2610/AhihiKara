...
public class VideoSinging extends Activity /*implements OnClickListener*/ {

    private SurfaceView surface1;
    private Button start, stop, pre, btnPlay, btnStop;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.video_singing);
